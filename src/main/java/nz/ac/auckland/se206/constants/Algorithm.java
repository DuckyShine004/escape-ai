...
/**
 * This constants class contains the database of psuedocodes that could be randomly drawn form for
 * the decryption puzzle. The algorithms are stored as strings.
 */
